...
T["en"] = dict(
    ...
    audit=dict(
        ...
        f=dict(error1="Please fill in your name, company and a valid email address.", error2="The message could not be sent. Please email us directly at <a href=\"mailto:hello@olimann.com\">hello@olimann.com</a>.",
               ...
               q4="What would you do with 20% more capacity next quarter?",
               q5="Which tools run sales, delivery and support today?",
               q6="Who is the most expensive person in the company, and what do they do on a typical Tuesday?",
...
T["de"] = dict(
    ...
    audit=dict(
        ...
        f=dict(error1="Bitte geben Sie Name, Unternehmen und eine gültige E-Mail-Adresse an.", error2="Die Nachricht konnte nicht gesendet werden. Bitte schreiben Sie uns direkt an <a href=\"mailto:hello@olimann.com\">hello@olimann.com</a>.",
               ...
               q4="Was würden Sie im nächsten Quartal mit 20 % mehr Kapazität tun?",
               q5="Welche Tools laufen heute in Vertrieb, Umsetzung und Support?",
               q6="Wer ist die teuerste Person im Unternehmen – und was macht sie an einem typischen Dienstag?",
